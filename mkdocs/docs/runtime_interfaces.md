...
| ------------- | ----------- |
| IOCTL_FILE_INFO | Same as the "file / directory xattrs" mentioned above. Use a buffer size of bytes. Pass in a string of "basepath", "relpath", "fullpath", or "allpaths". Receive details in same buffer overwriting what was there. |
